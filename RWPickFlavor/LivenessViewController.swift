...
public class LivenessCheckViewController: UIViewController {
    ...
    public var detectionOptions = [" 👉🏻 Look Right",
                                    " 👈🏻 Look Left",
                                    " 🙂 Smile :)"]
    ...
    override func viewDidLoad() {
        ...
        let segmentWidth =  (screenHeight - 100)/2 + 80;
        let segmentHeight = (screenHeight - 100)/2 + 80 ;
